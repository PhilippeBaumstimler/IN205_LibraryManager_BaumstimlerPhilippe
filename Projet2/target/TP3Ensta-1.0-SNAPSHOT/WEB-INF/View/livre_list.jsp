                ...
                <tbody>
                  <c:forEach var="livre" items="${livres}">
                    <tr>
                        ...
                        <td><c:out value="${livre.getIsbn()}" /></td>
                        <td class="center"><a href="livre_details?id=${livre.getId()}"> Cliquez-ici pour plus de détails <ion-icon class="details" name="information-circle-outline"></ion-icon></a></td>
                    </tr>
                  </c:forEach>
