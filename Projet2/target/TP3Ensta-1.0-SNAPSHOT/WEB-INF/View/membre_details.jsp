...
<body>
  ...
  <main>
    <section class="content">
      ...
      <div class="row">
      <div class="container">
      <h5>D�tails du membre n�${membre.getId()}</h5> <!-- TODO : remplacer 007 par l'id du membre -->
        <div class="row">
          ...
          <div class="col s12">
	        <table class="striped">
              ...
              <tbody id="results">
                ...
                <tr>
                  <td><c:out value="${livres.get(i).getTitre()}"/> de <c:out value="${livres.get(i).getAuteur()}"/> </td>
