...
public class Membre {
	...
	public Membre(int i, String n, String p, String ad, String e, String t, Abonnement ab) {
		this.id = i;
		this.nom = n;
		this.prenom = p;
		this.adresse = ad;
	...
	public Membre(String n, String p, String ad, String e, String t, Abonnement ab) {
		this.nom = n;
		this.prenom = p;
		this.adresse = ad;
		this.email = e;
	...
	public Membre(String n, String p, String ad, String e, String t) {
		this.nom = n;
		this.prenom = p;
		this.adresse = ad;
		this.email = e;
